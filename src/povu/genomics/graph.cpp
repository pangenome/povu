...
#include "povu/genomics/bfs_tree.hpp"
...
povu::graph::bfs::BfsTree comp_bfs_tree(const bd::VG &g, pvst::route_e route,
...
pt::status_t enum_walks(const bd::VG &g, pvst::route_e route, idx_or_t src,
			idx_or_t snk, std::vector<pvr::enhanced_walk> &walks,
...
std::vector<pt::id_t> bfs_sort(const bd::VG &g, pvr::RoV &rov)
{
	...
	povu::graph::bfs::BfsTree t = comp_bfs_tree(g, route, src, snk);
