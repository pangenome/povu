...
//	{
//		matrix2d<T, U> m(this->rows(), this->cols());
//		std::vector<U> cn = this->get_col_names();
//		std::vector<U> rn = this->get_row_names();
//		m.add_col_names(std::move(cn));
//		m.add_row_names(std::move(rn));

//		return m;
//	}

//	[[nodiscard]]
//	pt::u32 max_depth() const
//	{
//		return this->max_depth_;
//	}

//	[[nodiscard]]
//	pt::u32 &max_depth_mut()
//	{
//		return this->max_depth_;
//	}
...
//	[[nodiscard]]
//	const std::vector<U> &get_row_names() const
//	{
...
//				"{} Row names size {} does "
//				"not match row count {}",
//				MODULE, names.size(), this->rows());
//			throw std::invalid_argument(err);
//		}

//		row_names = std::move(names);
//	}
