#ifndef POVU_TREE_INTERVAL_TREE_HPP
#define POVU_TREE_INTERVAL_TREE_HPP
...
{
constexpr std::string_view MODULE = "povu::tree::interval_tree";
...
namespace poi = povu::tree::interval_tree;

#endif // POVU_TREE_INTERVAL_TREE_HPP
