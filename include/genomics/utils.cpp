...
void comp_walks_s2e(const bd::VG &g, pvt::RoV &rov) {
...
void find_walks(const bd::VG &g, pvt::RoV &rov) {
  ...
  if (rp_route == pvst::route_e::s2e) {
    comp_walks_s2e(g, rov);
  } else {
    comp_walks_e2s(g, s, t, rov.get_walks_mut(), rov.get_pvst_vtx()->as_str());
  }
}
} // namespace graph
